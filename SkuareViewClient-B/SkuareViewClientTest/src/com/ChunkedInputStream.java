...
public class ChunkedInputStream extends InputStream
{
	...
	/** Indicates if there is more chunks */
	...
	/**
		...
		@param in A <code>InputStream</code> object as a base stream.
	*/
	...
	*/
	...
	/**
	 * Used internally to read lines from the input stream and control if
	 * the end of stream is reached unexpectedly.
	 *
	...
	private String readLine() throws IOException
	{
		...
		else throw new EOFException("Unexpected end of stream decoding chunk");
	}
	
	/**
		Reads the next byte of the chunked content. It will return -1 if there is no
		more chunks to decode. If the end of stream is reached before decoding
